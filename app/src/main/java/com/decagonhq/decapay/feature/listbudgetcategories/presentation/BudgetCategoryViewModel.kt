...
class BudgetCategoryViewModel @Inject constructor(
    ...
    private val _budgetCategoryListResponse = MutableStateFlow<Resource<Any>>(Resource.Loading())
    val budgetCategoryListResponse: StateFlow<Resource<Any>> get() = _budgetCategoryListResponse
